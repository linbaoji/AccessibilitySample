...
final public class Constants {
    ...
    public static final String SHARE_PREFERENCES_DATABASE_NAME ="ACCESSIBILITY_SXF_PLUSH";
    public static final String SHARE_PREFERENCES_DATA_KEY ="SHARE_PREFERENCES_DATA_KEY";
